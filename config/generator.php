...
return [
    ...
    'order_redis_len_limit' => env('ORDER_REDIS_LEN_LIMIT', 100), //每次检查redis，长度小于此值追加
    ...
    'order_redis_onestep' => env('ORDER_REDIS_ONESTEP', 10), //每次插入redis号码的数量
    'orderdb_onestep' => env('ORDERDB_ONESTEP', 12), //每次插入数据库order_numlogs号码的数量


    'stream_init_num' => env('STREAM_INIT_NUM', 1),//流水号码初始值 12位
    'stream_redis_len_limit' => env('STREAM_REDIS_LEN_LIMIT', 100), //每次检查redis，长度小于此值追加
    ...
    'stream_redis_onestep' => env('STREAM_REDIS_ONESTEP', 10), //每次插入redis号码的数量
